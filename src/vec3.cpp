...
vec3::vec3(float x, float y, float z) noexcept : x_(x), y_(y), z_(z) {}
...
[[nodiscard]] vec3 vec3::NEG_X() noexcept { return vec3{-1.f, 0.f, 0.f}; }
[[nodiscard]] vec3 vec3::NEG_Y() noexcept { return vec3{0.f, -1.f, 0.f}; }
[[nodiscard]] vec3 vec3::NEG_Z() noexcept { return vec3{0.f, 0.f, -1.f}; }
